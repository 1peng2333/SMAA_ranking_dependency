...
command2 = f"open /content/{Dir_name}/top10_ab_test.pdb; open /content/{Dir_name}/IWS_ab_test.pdb; open /content/{Dir_name}/IBS_ab_test.pdb; open /content/{Dir_name}/all_ab_test.pdb; open /content/{Dir_name}/box6nn.bild;"
...
command10= f"shape sphere radius {radius} color 1,1,1,0.5 mesh true;"
...
#command14 = f"save /content/{Dir_name_s}/result/07_visualize_PCA.png;"
#run(session, command14)

command15 = f"save /content/{Dir_name_s}/result/07_visualize_PCA.cxs;"
